...
export const metadata = {
  metadataBase: new URL('https://s3ai.com'),
  title: {
    default: 's3 ai interview',
    ...
    <ClerkProvider>
      ...
      >
        ...
        >
          ...
          <main 
            id="main-content" 
            className="flex-grow w-full px-4 pt-16 mx-auto sm:pt-20 max-w-7xl sm:px-6 lg:px-8"
          >
            {children}
          </main>
